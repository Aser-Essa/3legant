    ...
    <>
      <div className="relative mt-20 h-[360px] overflow-hidden bg-[#F2F4F6] max-sm:mt-10">
        ...
        <motion.img
          ...
          viewport={{ once: true }}
        />
        <div className="mx-auto flex h-full w-fit flex-col items-center justify-center text-nowrap text-center text-black-shade-1">
          <div className="mb-2 min-w-full text-nowrap text-[40px] font-medium leading-[44px] tracking-[-0.4px] max-sm:min-w-[300px] max-sm:text-[34px]">
