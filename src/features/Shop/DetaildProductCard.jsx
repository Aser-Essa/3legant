...
function DetaildProductCard({ product, gridType }) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`relative h-[349px] ${isGrid2 ? "w-[266px]" : "min-w-[auto]"} rounded-sm bg-white-shade-2 p-4 max-sm:h-[308px] max-sm:p-[14px]`}
        >
        ...
        <div
          className={`mt-3 p-6 font-inter font-semibold max-xl:w-full max-sm:py-0 ${isGrid2 ? "" : "w-full"}`}
        >
